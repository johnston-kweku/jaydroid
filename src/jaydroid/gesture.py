...
class Gesture:
    ...
    Args:
        device (Device): Device whose display dimensions are used for
    ...
    class Swipe():
        ...
        def swipe(self, x1, y1, x2, y2, delay=0):
            ...
            Args:
                x1 (int): Starting x-coordinate in pixels.
                y1 (int): Starting y-coordinate in pixels.
                x2 (int): Ending x-coordinate in pixels.
                y2 (int): Ending y-coordinate in pixels.
    ...
    class Tap:
        ...
        def double_tap(self, x, y, delay=0):
            ...
            Returns:
                subprocess.CompletedProcess: The result of the second tap's ADB command.
            """
        ...
        def longpress(self, x, y, duration=3000, delay=0):
            ...
            Args:
                x (int): X-coordinate in pixels.
                y (int): Y-coordinate in pixels.
                duration (int): Press duration in milliseconds. Defaults to ``3000`` (3 seconds).
